    ...
    private void complaint(ComplaintEntity complaint) {
        ...
        switch (orderType) {
            ...
            case 1:     //货物
                ...
                map.put("orderNumber",complaint.getOrderId());
                GoodsOrderEntity goodsOrder = goodsOrderDao.queryObjectByCompanyIdOrOrderNumber(map);
...
//                complaintTo = complaint.getComplaintTo();
                if (Integer.valueOf(goodsOrder.getPurchaserCompanyId()) == complaintFromId) {   //买家投诉
