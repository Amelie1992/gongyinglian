...
import com.wzlue.chain.sys.dao.SysMenuDao;
import com.wzlue.chain.sys.entity.SysMenuEntity;
import com.wzlue.chain.sys.service.SysMenuService;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	@Override
	public List<SysMenuEntity> getGrantMenuList(Long userId) {
		return sysMenuDao.getGrantMenuList(userId);
	}
}
