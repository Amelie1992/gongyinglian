var vm = new Vue({
    ...
    methods: {
         ...
         *
         * */
        changeOrderCharts: function (nodeName, txt, type, dataList, labelsList) {
            $("#" + nodeName).highcharts({
                title: {text: txt},
                subtitle: {
                    text: type
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code == 0) {
                        ...
                        vm.changeOrderCharts(nodeName, '订单成交量',Statistical, res.list, res.itemList);
                    } else {
                        alert(res.msg);
                    }
                }
        ...
        receivableRequestData: function (nodeName, type, params) {
            ...
            $.ajax({
                type: 'post',
                url: baseURL + "reportform/highcharts/receivable",
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: function (res) {
                    if (res.code == 0) {
                        ...
                        vm.changeOrderCharts(nodeName, '应收应付', Statistical, res.list, res.itemList);
                    } else {
                        alert(res.msg);
                    }
                }
        ...
        userRequestData: function (nodeName, type, params) {
            ...
            $.ajax({
                type: 'post',
                url: baseURL + "reportform/highcharts/adduser",
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: function (res) {
                    if (res.code == 0) {
                        vm.changeOrderCharts(nodeName, '新增客户量', Statistical, res.list, res.itemList);
                    } else {
                        alert(res.msg);
                    }
                }
