        ...
        methods: {
            ...
            checkOnly: function () {
                ...
                if (vm.itemCategory.id == null) {
                    var URL = "goods/category/checkOnly?categoryName=" + vm.itemCategory.categoryName
                        + "&taxNumber=" + vm.itemCategory.taxNumber;
                } else {
                    var URL = "goods/category/checkOnly?categoryName=" + vm.itemCategory.categoryName
                        + "&taxNumber=" + vm.itemCategory.taxNumber + "&id=" + vm.itemCategory.id;
                }
