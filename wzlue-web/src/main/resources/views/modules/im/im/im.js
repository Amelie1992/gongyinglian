;(function (RCS) {
    ...
    var modificateMessage = function (list) {
        console.log("消息修饰，2条消息之间相差6000毫秒，显示消息发送时间");
    ...
    var keyboard = function (event) {
        console.log("H5唤醒键盘的时候输入框显示在视野内");
        var thisTarget = event.target || event.srcElement;
        setTimeout(function () {
