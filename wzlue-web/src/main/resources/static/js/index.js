...
var vm = new Vue({
    ...
    methods: {
        downloadTemplate:function(){
            window.location.href=baseURL+"template/contract.zip";
        },
        toSuHang:function(){
            //登录token
        ...
        kefu: function () {
          ...
          var url= "company/merchantusers/getCustomerService?companyId="+'';
                ...
                success: function(r){
                    if(r.code === 0){
                        ...
                        if(r.data != null){
                            ...
                            if(r.data.nikename == null){
                                obj.nikename= obj.name;
                            }else{
                                obj.nikename=r.data.nikename
                            }
                        }else{
            ...
            if(kefuNum == 1){
                ...
                var nikename = encodeURIComponent(encodeURIComponent(vm.user.nikename));
                var b = encodeURIComponent(encodeURIComponent(JSON.stringify(obj)));
                window.open(window.location.origin + '/modules/huanxin/jQuery/index.html?username=' + a + "&nikename="+nikename+"&kefu=" + b);
            }
        },
        huanxin: function () {
            var a = encodeURIComponent(encodeURIComponent(vm.user.username));
            var nikename = encodeURIComponent(encodeURIComponent(vm.user.nikename));
            window.open(window.location.origin + '/modules/huanxin/jQuery/index.html?username=' + a + "&nikename="+nikename+"&kefu=");
        },
        //聊天
        wechat: function () {
            console.log("聊天弹出穿");
