...
public class LogisticsOrderEntity implements Serializable {
	...
	//物流报盘
	private LogisticsOfferEntity logisticsOffer;

    public LogisticsOfferEntity getLogisticsOffer() {
        return logisticsOffer;
    }

    public void setLogisticsOffer(LogisticsOfferEntity logisticsOffer) {
        this.logisticsOffer = logisticsOffer;
    }
